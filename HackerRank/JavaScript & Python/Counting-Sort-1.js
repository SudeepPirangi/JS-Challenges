...
int[100]: a frequency arrayˀ
 */

function countingSort(arr) {
  // should return only 100 elements so consider only first 100
  const frequencyArray = [...arr.slice(0, 100)].fill(0);
...
console.log(countingSort(bigArray));
